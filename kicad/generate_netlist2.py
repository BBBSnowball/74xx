...
if __name__ == '__main__':
    ...
    _, output_file, json_file, xml_netlist_file, placement_file = sys.argv
    ...
    #skidl.ERC()
    skidl.generate_netlist(file_=output_file)
    #x = skidl.generate_pcb(pcb_file=name+'.kicad_pcb')  # needs kinet2pcb and newer skidl
    #print(repr(x))
